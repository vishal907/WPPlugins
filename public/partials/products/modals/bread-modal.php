<div id="bread-modal" class="modal fade iofSinglePageModal" role="dialog">
                ...
                <div class="row">
                    <div class="col-xs-12 breads_radio_buttons">
                        <?php $n=0; foreach ( $available_breads as $bread ) { $n++; ?>
                            <div class="thumbnail productModalPopup <?php if( strcmp($default_bread, $bread['title']) == 0 ) { echo 'item-selected'; } ?>" >
